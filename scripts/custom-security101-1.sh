...
curl -X POST "http://localhost:30001/api/detection_engine/rules/_bulk_create" \
     ...
     -d @/root/simple-data-generator/detection-rules/101-1.json
...
java -jar /root/simple-data-generator/build/libs/simple-data-generator-1.0.0-SNAPSHOT.jar \
     /root/simple-data-generator/tracks/security-101-1.yml
